...
- **竞技场结算提醒**
- **公会战管理**：详细说明见[此文档](rin/modules/pcrclanbattle/clanbattle/README.md)
- **Rank推荐表搬运**
- **常用网址速查**
- **官方推特转发**
- **官方四格推送**
...
> 由于bot的功能会快速迭代开发，使用方式这里不进行具体的说明，请向bot发送"help"或移步[此文件](rin/modules/botmanage/help.py)查看详细。会战管理功能的详细说明，请[点击这里](rin/modules/pcrclanbattle/clanbattle/README.md)
...
5. 编辑配置文件
    ```bash
    mv rin/config_example rin/config
    nano rin/config/__bot__.py
    ```
