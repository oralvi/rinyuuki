...
from rin import Service, util
from rin.modules.priconne import _pcr_data, chara
from rin.typing import CQEvent
from rin.typing import MessageSegment as Seg

from . import GameMaster

PATCH_SIZE = 32
ONE_TURN_TIME = 20
DB_PATH = os.path.expanduser("~/.rin/pcr_avatar_guess.db")
