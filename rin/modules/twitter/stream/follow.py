...
from rin import Service, priv
from rin.config import twitter as cfg
from rin.typing import MessageSegment as ms
...
class UserIdCache:
    _cache_file = os.path.expanduser("~/.rin/twitter_uid_cache.json")
    ...
    def __init__(self) -> None:
        ...
        if os.path.isfile(self._cache_file):
            try:
                ...
                sv.logger.error(f"{type(e)} occured when loading `~/.rin/twitter_uid_cache.json`, using empty cache.")
