...
SUPERUSERS = [41235718]    # 填写超级用户的QQ号，可填多个用半角逗号","隔开
NICKNAME = ["结城凛","rin","@rin","凛"]           # 机器人的昵称。呼叫昵称等同于@bot，可用元组配置多个昵称
PYS = {}
COMMAND_START = {''}    # 命令前缀（空字符串匹配任何消息）
COMMAND_SEP = set()     # 命令分隔符（hoshino不需要该特性，保持为set()即可）

USE_CQPRO =True
APIKEY = '762262525f77f7b1532470'
# 发送图片的协议
# 可选 http, file, base64
# 当QQ客户端与bot端不在同一台计算机时，可用http协议
RES_PROTOCOL = 'file'
# 资源库文件夹，需可读可写，windows下注意反斜杠转义
RES_DIR = r'/home/projectrin/res/'
